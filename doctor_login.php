...
<?php
    ...
    if(isset($_POST['doctor_login'])){
        ...
        if(mysqli_num_rows($result)==1)
        {
          ...
          $_SESSION['doctorFee'] = $row['doctorFee'];
        }
                ...
                <div class="card" style="border-radius: 1.5rem;">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-justified bg-primary" style="border-radius: 1.5rem;" id="myTab" role="tablist" style="width: 300px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="doctor_login.php">Doctor</a>
                            </li>
                        </ul><br><br>
                        <h4 class="text-center text-light">Doctor Login</h4><br>
                        <form action="" method="post">
                            ...
                            <center><button class="btn btn-primary" type="submit" name="doctor_login">Login</button></center>
                        </form>
